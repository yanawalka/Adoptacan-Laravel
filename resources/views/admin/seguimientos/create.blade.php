...
@section('title','Ingresar Nuevo Registro De Seguimiento')


@section('content')

	{!! Form::open(['route' => 'admin.seguimientos.store','method' => 'POST','files'=>true]) !!}
		...
		<div class="form-group">
			<div class="row">
				<div class="col-lg-8">	
					...
					{!! Form::textarea('detalle',null,['class' => 'form-control', 'placeholder' => 'Detalle','required']) !!}
				</div>	
